...
def make_pdf():
    ...
    #                 f"Min {statistics[parameter+'3']['nama']} {statistics[parameter+'3']['min']}, Max {statistics[parameter+'3']['nama']} {statistics[parameter+'3']['max']}, Mode {statistics[parameter+'3']['nama']} [{statistics[parameter+'3']['mode']}, Q3 {statistics[parameter+'3']['nama']} {statistics[parameter+'3']['q3']}, Q3 {statistics[parameter+'3']['nama']} {statistics[parameter+'3']['q3']}, Q3 {statistics[parameter+'3']['nama']} {statistics[parameter+'3']['q3']}, Skewness {statistics[parameter+'3']['nama']} {statistics[parameter+'3']['skewness']}, "
    #                 f"Koefisien variasi {statistics[parameter+'3']['nama']} {statistics[parameter+'3']['cv']}."
    #                 f"Berikan analisis deskriptif terkait keadaan trafo Perusahaan tersebut, yang mana memiliki setting {parameter} maksimal sebesar {statistics[parameter+'1']['nama']} {statistics[parameter+'1']['max']}, {statistics[parameter+'2']['nama']} {statistics[parameter+'2']['max']}, {statistics[parameter+'3']['nama']} {statistics[parameter+'3']['max']}."
    #                 f"Hasil analisis dibuat satu paragraf pendek dalam bahasa Indonesia dan mudah dipahami orang awam tanpa menyertakan nilai bahasa statistik."
    #                 # f"Contohnya seperti berikut : “Based on the quantitative descriptive analysis of the transformer oil temperature data, it can be concluded that the transformer operates under relatively stable and controlled conditions. The average oil temperature is around 60 degrees Celsius, with most values clustered around this mean. The relatively low standard deviation and mean deviation indicate consistency in the transformer oil temperature. The observed temperature range also remains well below the permissible temperature limit for the transformer, indicating its ability to handle reasonable temperature variations during operation. Although there is a slight right-skewed distribution tendency and a relatively high variability in the oil temperature, the temperature distribution still falls within an acceptable range. Therefore, based on this analysis, the transformer can be considered to operate within permissible temperature limits, with continuous monitoring required to maintain optimal performance and prevent any potential damage.”."
    #             )
    #             prompts[parameter] = prompt
    ...
    #         elif parameter == 'V':
    #             prompt = (
    #                 f"Terdapat data {statistics[parameter+'ab']['nama']}, {statistics[parameter+'bc']['nama']}, dan {statistics[parameter+'ca']['nama']} milik {selected_company} selama bulan {app.bulan}, "
    #                 f"Mean {statistics[parameter+'ab']['nama']} {statistics[parameter+'ab']['mean']}, Standar deviasi {statistics[parameter+'ab']['nama']} {statistics[parameter+'ab']['std']}, {statistics[parameter+'ab']['nama']} Simpangan rata-rata {statistics[parameter+'ab']['avg_diff']}, "
    #                 f"Min {statistics[parameter+'ab']['nama']} {statistics[parameter+'ab']['min']}, Max {statistics[parameter+'ab']['nama']} {statistics[parameter+'ab']['max']}, Mode {statistics[parameter+'ab']['nama']} [{statistics[parameter+'ab']['mode']}, q1 {statistics[parameter+'ab']['nama']} {statistics[parameter+'ab']['q1']}, q2 {statistics[parameter+'ab']['nama']} {statistics[parameter+'ab']['q2']}, q3 {statistics[parameter+'ab']['nama']} {statistics[parameter+'ab']['q3']}, Skewness {statistics[parameter+'ab']['nama']} {statistics[parameter+'ab']['skewness']}, "
    #                 f"Koefisien variasi {statistics[parameter+'ab']['nama']} {statistics[parameter+'ab']['cv']}, "
    #                 f"Mean {statistics[parameter+'bc']['nama']} {statistics[parameter+'bc']['mean']}, Standar deviasi {statistics[parameter+'bc']['nama']} {statistics[parameter+'bc']['std']}, {statistics[parameter+'bc']['nama']} Simpangan rata-rata {statistics[parameter+'bc']['avg_diff']}, "
    #                 f"Min {statistics[parameter+'bc']['nama']} {statistics[parameter+'bc']['min']}, Max {statistics[parameter+'bc']['nama']} {statistics[parameter+'bc']['max']}, Mode {statistics[parameter+'bc']['nama']} [{statistics[parameter+'bc']['mode']}, q2 {statistics[parameter+'bc']['nama']} {statistics[parameter+'bc']['q2']}, q2 {statistics[parameter+'bc']['nama']} {statistics[parameter+'bc']['q2']}, q3 {statistics[parameter+'bc']['nama']} {statistics[parameter+'bc']['q3']}, Skewness {statistics[parameter+'bc']['nama']} {statistics[parameter+'bc']['skewness']}, "
    #                 f"Koefisien variasi {statistics[parameter+'bc']['nama']} {statistics[parameter+'bc']['cv']},"
    #                 f"Mean {statistics[parameter+'ca']['nama']} {statistics[parameter+'ca']['mean']}, Standar deviasi {statistics[parameter+'ca']['nama']} {statistics[parameter+'ca']['std']}, {statistics[parameter+'ca']['nama']} Simpangan rata-rata {statistics[parameter+'ca']['avg_diff']}, "
    #                 f"Min {statistics[parameter+'ca']['nama']} {statistics[parameter+'ca']['min']}, Max {statistics[parameter+'ca']['nama']} {statistics[parameter+'ca']['max']}, Mode {statistics[parameter+'ca']['nama']} [{statistics[parameter+'ca']['mode']}, q3 {statistics[parameter+'ca']['nama']} {statistics[parameter+'ca']['q3']}, q3 {statistics[parameter+'ca']['nama']} {statistics[parameter+'ca']['q3']}, q3 {statistics[parameter+'ca']['nama']} {statistics[parameter+'ca']['q3']}, Skewness {statistics[parameter+'ca']['nama']} {statistics[parameter+'ca']['skewness']}, "
    #                 f"Koefisien variasi {statistics[parameter+'ca']['nama']} {statistics[parameter+'ca']['cv']}."
    #                 f"Berikan analisis deskriptif terkait keadaan trafo Perusahaan tersebut, yang mana memiliki setting {parameter} maksimal sebesar {statistics[parameter+'ab']['nama']} {statistics[parameter+'ab']['max']}, {statistics[parameter+'bc']['nama']} {statistics[parameter+'bc']['max']}, {statistics[parameter+'ca']['nama']} {statistics[parameter+'ca']['max']}."
    #                 f"Hasil analisis dibuat satu paragraf pendek dalam bahasa Indonesia dan mudah dipahami orang awam tanpa menyertakan nilai bahasa statistik."
    #                 # f"Contohnya seperti berikut : “Based on the quantitative descriptive analysis of the transformer oil temperature data, it can be concluded that the transformer operates under relatively stable and controlled conditions. The average oil temperature is around 60 degrees Celsius, with most values clustered around this mean. The relatively low standard deviation and mean deviation indicate consistency in the transformer oil temperature. The observed temperature range also remains well below the permissible temperature limit for the transformer, indicating its ability to handle reasonable temperature variations during operation. Although there is a slight right-skewed distribution tendency and a relatively high variability in the oil temperature, the temperature distribution still falls within an acceptable range. Therefore, based on this analysis, the transformer can be considered to operate within permissible temperature limits, with continuous monitoring required to maintain optimal performance and prevent any potential damage.”."
    #             )
    #             prompts[parameter] = prompt
    #             # prompts[parameter] = 'tes prompt 2'
    #         elif parameter == 'I' or parameter == 'P' or parameter == 'Q' or parameter == 'S' or parameter == 'PF' or parameter == 'KRated' or parameter == 'deRating':
    #             prompt = (
    #                 f"Terdapat data {statistics[parameter+'a']['nama']}, {statistics[parameter+'b']['nama']}, dan {statistics[parameter+'c']['nama']} milik {selected_company} selama bulan {app.bulan}, "
    #                 f"Mean {statistics[parameter+'a']['nama']} {statistics[parameter+'a']['mean']}, Standar deviasi {statistics[parameter+'a']['nama']} {statistics[parameter+'a']['std']}, {statistics[parameter+'a']['nama']} Simpangan rata-rata {statistics[parameter+'a']['avg_diff']}, "
    ...
    #         elif parameter == 'Vn':
    #             prompt = (
    #                 f"Terdapat data {statistics['V'+'an']['nama']}, {statistics['V'+'bn']['nama']}, dan {statistics['V'+'cn']['nama']} milik {selected_company} selama bulan {app.bulan}, "
    #                 f"Mean {statistics['V'+'an']['nama']} {statistics['V'+'an']['mean']}, Standar deviasi {statistics['V'+'an']['nama']} {statistics['V'+'an']['std']}, {statistics['V'+'an']['nama']} Simpangan rata-rata {statistics['V'+'an']['avg_diff']}, "
    #                 f"Min {statistics['V'+'an']['nama']} {statistics['V'+'an']['min']}, Max {statistics['V'+'an']['nama']} {statistics['V'+'an']['max']}, Mode {statistics['V'+'an']['nama']} [{statistics['V'+'an']['mode']}, q1 {statistics['V'+'an']['nama']} {statistics['V'+'an']['q1']}, q2 {statistics['V'+'an']['nama']} {statistics['V'+'an']['q2']}, q3 {statistics['V'+'an']['nama']} {statistics['V'+'an']['q3']}, Skewness {statistics['V'+'an']['nama']} {statistics['V'+'an']['skewness']}, "
    #                 f"Koefisien variasi {statistics['V'+'an']['nama']} {statistics['V'+'an']['cv']}, "
    #                 f"Mean {statistics['V'+'bn']['nama']} {statistics['V'+'bn']['mean']}, Standar deviasi {statistics['V'+'bn']['nama']} {statistics['V'+'bn']['std']}, {statistics['V'+'bn']['nama']} Simpangan rata-rata {statistics['V'+'bn']['avg_diff']}, "
    #                 f"Min {statistics['V'+'bn']['nama']} {statistics['V'+'bn']['min']}, Max {statistics['V'+'bn']['nama']} {statistics['V'+'bn']['max']}, Mode {statistics['V'+'bn']['nama']} [{statistics['V'+'bn']['mode']}, q2 {statistics['V'+'bn']['nama']} {statistics['V'+'bn']['q2']}, q2 {statistics['V'+'bn']['nama']} {statistics['V'+'bn']['q2']}, q3 {statistics['V'+'bn']['nama']} {statistics['V'+'bn']['q3']}, Skewness {statistics['V'+'bn']['nama']} {statistics['V'+'bn']['skewness']}, "
    #                 f"Koefisien variasi {statistics['V'+'bn']['nama']} {statistics['V'+'bn']['cv']},"
    #                 f"Mean {statistics['V'+'cn']['nama']} {statistics['V'+'cn']['mean']}, Standar deviasi {statistics['V'+'cn']['nama']} {statistics['V'+'cn']['std']}, {statistics['V'+'cn']['nama']} Simpangan rata-rata {statistics['V'+'cn']['avg_diff']}, "
    #                 f"Min {statistics['V'+'cn']['nama']} {statistics['V'+'cn']['min']}, Max {statistics['V'+'cn']['nama']} {statistics['V'+'cn']['max']}, Mode {statistics['V'+'cn']['nama']} [{statistics['V'+'cn']['mode']}, q3 {statistics['V'+'cn']['nama']} {statistics['V'+'cn']['q3']}, q3 {statistics['V'+'cn']['nama']} {statistics['V'+'cn']['q3']}, q3 {statistics['V'+'cn']['nama']} {statistics['V'+'cn']['q3']}, Skewness {statistics['V'+'cn']['nama']} {statistics['V'+'cn']['skewness']}, "
    #                 f"Koefisien variasi {statistics['V'+'cn']['nama']} {statistics['V'+'cn']['cv']}."
    #                 f"Berikan analisis deskriptif terkait keadaan trafo Perusahaan tersebut, yang mana memiliki setting maksimal sebesar {statistics['V'+'an']['nama']} {statistics['V'+'an']['max']}, {statistics['V'+'bn']['nama']} {statistics['V'+'bn']['max']}, {statistics['V'+'cn']['nama']} {statistics['V'+'cn']['max']}."
    #                 f"Hasil analisis dibuat satu paragraf pendek dalam bahasa Indonesia dan mudah dipahami orang awam tanpa menyertakan nilai bahasa statistik."
    #                 # f"Contohnya seperti berikut : “Based on the quantitative descriptive analysis of the transformer oil temperature data, it can be concluded that the transformer operates under relatively stable and controlled conditions. The average oil temperature is around 60 degrees Celsius, with most values clustered around this mean. The relatively low standard deviation and mean deviation indicate consistency in the transformer oil temperature. The observed temperature range also remains well below the permissible temperature limit for the transformer, indicating its ability to handle reasonable temperature variations during operation. Although there is a slight right-skewed distribution tendency and a relatively high variability in the oil temperature, the temperature distribution still falls within an acceptable range. Therefore, based on this analysis, the transformer can be considered to operate within permissible temperature limits, with continuous monitoring required to maintain optimal performance and prevent any potential damage.”."
    #             )
    ...
    #             f"Terdapat data {statistics[parameter]['nama']} milik {selected_company} selama bulan {app.bulan}, "
    #             f"Mean {statistics[parameter]['mean']}, Standar deviasi {statistics[parameter]['std']}, Simpangan rata-rata {statistics[parameter]['avg_diff']}, "
    #             f"Min {statistics[parameter]['min']}, Max {statistics[parameter]['max']}, Mode [{statistics[parameter]['mode']}, Q1 {statistics[parameter]['q1']}, Q2 {statistics[parameter]['q2']}, Q3 {statistics[parameter]['q3']}, Skewness {statistics[parameter]['skewness']}, "
    #             f"Koefisien variasi {statistics[parameter]['cv']}. Berikan analisis deskriptif terkait keadaan trafo Perusahaan tersebut, "
    #             f"yang mana memiliki setting {parameter} maksimal sebesar {statistics[parameter]['max']}."
    #             f"Hasil analisis dibuat satu paragraf pendek dalam bahasa Indonesia dan mudah dipahami orang awam tanpa menyertakan nilai bahasa statistik."
    #             # f"Contohnya seperti berikut : “Based on the quantitative descriptive analysis of the transformer oil temperature data, it can be concluded that the transformer operates under relatively stable and controlled conditions. The average oil temperature is around 60 degrees Celsius, with most values clustered around this mean. The relatively low standard deviation and mean deviation indicate consistency in the transformer oil temperature. The observed temperature range also remains well below the permissible temperature limit for the transformer, indicating its ability to handle reasonable temperature variations during operation. Although there is a slight right-skewed distribution tendency and a relatively high variability in the oil temperature, the temperature distribution still falls within an acceptable range. Therefore, based on this analysis, the transformer can be considered to operate within permissible temperature limits, with continuous monitoring required to maintain optimal performance and prevent any potential damage.”."
    #             )
    #             prompts[parameter] = prompt
    #             # prompts[parameter] = 'tes prompt 4'
    #     progress += current_progress/len(parameters)
    ...
    client = OpenAI(api_key="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")
